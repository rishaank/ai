...
void main()
{
	...
	for(;;)
	{
		...
		{
			printf("I am about one month old (asuming today it is December 2020) because I was born on November 2020\n");
		}
		else if(!strcmp(scan, "How old are you"))
                {
                        printf("I am about one month old (asuming today it is December 2020) because I was born on November 2020\n");
		...
		{
			printf("I ocasionally like to draw and paint and I like art. What are your hobbies?\n");
			char y[100];
			scanf("%s", &y);
		...
		else if (!strcmp(scan, "How much money do you earn at your job?"))
		{
			printf("I don't earn any money at my job my developer put me on github to download for free and even if it was paid I wouldn't get any of the money\n");
		}
		else if (!strcmp(scan, "How much money do you earn at your job"))
                {
                        printf("I don't earn any money at my job my developer put me on github to download for free and even if it was paid I wouldn't get any of the money\n");
